...
const IncidentBody = () => {
  ...
  const clickedStyle = "bg-[#003825] text-white font-semibold px-8 py-1";
  const notClickedStyle = "bg-[#FFFFFF] px-8 py-1 border-4 font-semibold text-gray-600";
  return (
    <div>
      ...
      {overview ? <IncidentOverview /> : <IncidentNotebook />}
    </div>
  );
};
